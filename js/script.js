...
const section02Animation = () => {
  ...
  ql.fromTo(".django", { y: "0%" }, { x: "-700%", y: "350%" }, 1.6);
  ql.fromTo(".figma", { y: "0%" }, { x: "-650%", y: "-200%" }, 1.8);
  ql.fromTo(".github", { y: "0%" }, { x: "650%", y: "300%" }, 2.0);
  ql.fromTo(".html", { y: "0%" }, { x: "650%", y: "-300%" }, 2.2);
  ql.fromTo(".js", { y: "0%" }, { x: "750%", y: "150%" }, 2.4);
  ql.fromTo(".react", { y: "0%" }, { x: "-485%", y: "250%" }, 2.6);
  ql.fromTo(".tailwind", { y: "0%" }, { x: "0%", y: "-350%" }, 2.8);
  ql.fromTo(".discord", { y: "0%" }, { x: "-600%", y: "0%" }, 3);
  ql.fromTo(".gitlab", { y: "0%" }, { x: "400%", y: "-400%" }, 3.2);
  ql.fromTo(".aws", { y: "0%" }, { x: "450%", y: "350%" }, 3.4);
...
//       ql.fromTo(".python", { y: "0%" }, { x: "500%", y: "100" }, 1.2);
//       ql.fromTo(".css", { y: "0%" }, { x: "-550%", y: "-350%" }, 1.4);
//       ql.fromTo(".django", { y: "0%" }, { x: "-800%", y: "450%" }, 1.6);
//       ql.fromTo(".figma", { y: "0%" }, { x: "-750%", y: "-300%" }, 1.8);
//       ql.fromTo(".github", { y: "0%" }, { x: "750%", y: "400%" }, 2.0);
//       ql.fromTo(".html", { y: "0%" }, { x: "750%", y: "-400%" }, 2.2);
//       ql.fromTo(".js", { y: "0%" }, { x: "850%", y: "250%" }, 2.4);
//       ql.fromTo(".react", { y: "0%" }, { x: "-585%", y: "350%" }, 2.6);
//       ql.fromTo(".tailwind", { y: "0%" }, { x: "100%", y: "-550%" }, 2.8);
//       ql.fromTo(".discord", { y: "0%" }, { x: "-700%", y: "100%" }, 3);
//       ql.fromTo(".gitlab", { y: "0%" }, { x: "500%", y: "-500%" }, 3.2);
//       ql.fromTo(".aws", { y: "0%" }, { x: "500%", y: "450%" }, 3.4);
//       ql.fromTo(".section02 div.section-card", { y: "400%" }, { y: "0" }, 3.6);
//     },
//   });
// };
